...
def create_activity(user_id, body=None):  # noqa: E501
    """Create a new.
    ...
    :param user_id: The user that is doing the create.
    :type user_id: 
    :param body: Create a new &lt;a href&#x3D;\&quot;${org.sagebionetworks.repo.model.provenance.Activity}\&quot; &gt;Activity&lt;/a&gt;. If the passed &lt;a href&#x3D;\&quot;${org.sagebionetworks.repo.model.provenance.Activity}\&quot;&gt;Activity&lt;/a&gt; object contains a &lt;a href&#x3D;\&quot;${org.sagebionetworks.repo.model.provenance.Used}\&quot; &gt;Used&lt;/a&gt; array, you must set the concreteType field of each Used subclass. &lt;p&gt; Access Control: READ access is granted to those users who can see a single Entity that was generated by this Activity. &lt;/p&gt;
    :type body: str
